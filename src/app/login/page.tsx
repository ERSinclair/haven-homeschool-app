      ...
      try {
        ...
        if (profileRes.ok) {
          ...
          if (completionStep === 'complete') {
            console.log('Profile complete, going to discover');
            window.location.href = '/dashboard';
          } else {
            console.log('Profile incomplete, resuming signup at step:', completionStep);
            window.location.href = getResumeSignupUrl(completionStep);
          }
        } else {
