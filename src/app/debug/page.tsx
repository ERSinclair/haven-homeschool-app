        ...
        <div className="bg-white p-6 rounded-lg shadow-sm space-y-4">
          ...
          <div>
            ...
            <div className="space-y-2">
              <a href="/profile" className="block text-blue-600 hover:underline">→ Test Profile Page</a>
              <a href="/settings" className="block text-blue-600 hover:underline">→ Test Settings Page</a>
              <a href="/map" className="block text-blue-600 hover:underline">→ Test Map Page</a>
            </div>
          </div>
