    ...
    <div className="min-h-screen bg-gradient-to-b from-emerald-50 to-white">
      <div className="max-w-md mx-auto px-4 py-8">
        ...
        <div className="flex gap-2 mb-4 overflow-x-auto pb-2 scrollbar-hide justify-center">
          ...
          <button
            onClick={() => window.location.href = '/events?type=private'}
            className="px-6 py-2 rounded-full text-sm font-bold whitespace-nowrap transition-all shadow-sm min-w-fit flex items-center justify-center bg-white text-gray-700 hover:bg-teal-50 hover:text-teal-700 border border-gray-200 hover:border-teal-200 hover:shadow-md hover:scale-105"
          >
            Events
          </button>
        ...
        {(() => {
          ...
          <div className="text-center py-12">
            <div className="mb-4 flex justify-center">
              {searchTerm ? (
                <div className="text-6xl font-bold text-emerald-600">S</div>
              ) : (
                <AvatarUpload
                  userId=""
                  currentAvatarUrl=""
...
function CreateCircleModal({ 
  ...
  const handleCreate = async () => {
    ...
    if (isPublic === null) {
      setError('Please select if this circle should be public or private');
      return;
    }
    ...
    try {
      ...
      if (!response.ok) {
        ...
        console.error('Create circle failed:', response.status, errorText);
        throw new Error(`Failed to create circle: ${response.status} - ${errorText}`);
      }
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <input
              ...
              placeholder="Beach Day Crew, Coffee Catchups..."
          ...
          <div>
            ...
            <textarea
              ...
              className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-teal-500 focus:border-teal-500 resize-none"
              rows={2}
              maxLength={200}
            />
          </div>
              ...
              >
                <div className="flex items-center">
                  <div>
                    ...
                    <div className="text-sm text-gray-600">Anyone can discover and request to join</div>
                  </div>
                </div>
              </button>
              <button
              ...
              >
                <div className="flex items-center">
                  <div>
                    ...
                    <div className="text-sm text-gray-600">Only visible to members, invite-only</div>
                  </div>
                </div>
              </button>
            </div>
          ...
          <div className="flex gap-3 pt-4">
            ...
            <button
              ...
              disabled={creating || !name.trim() || isPublic === null}
