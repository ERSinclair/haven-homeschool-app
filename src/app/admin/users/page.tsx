...
export default function UserManagement() {
  ...
  const handleUnbanUser = async (user: User) => {
    if (!confirm(`Unban ${user.name}? They will be able to access the app again.`)) return;
          ...
          <div className="bg-white rounded-2xl max-w-md w-full p-6">
            <div className="text-center mb-6">
              ...
              <p className="text-gray-600">
                This will prevent {selectedUser.name} from accessing the app.
              </p>
            </div>
        ...
        <div className="fixed inset-0 bg-black/50 flex items-center justify-center p-4 z-50">
          <div className="bg-white rounded-2xl max-w-md w-full p-6">
            <div className="text-center mb-6">
              ...
              <p className="text-gray-600">
                <strong>This will permanently delete</strong> {selectedUser.name}'s account and all their data including messages, events, and profile information.
              </p>
