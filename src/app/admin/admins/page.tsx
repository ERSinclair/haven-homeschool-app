        ...
        <div className="grid lg:grid-cols-2 gap-8">
          ...
          <div className="bg-white rounded-xl shadow-sm overflow-hidden">
            <div className="px-6 py-4 border-b border-gray-200 bg-blue-50">
              ...
              <p className="text-sm text-blue-700">Users who can be promoted to admin</p>
            </div>
          ...
          <div className="bg-white rounded-2xl max-w-md w-full p-6">
            <div className="text-center mb-6">
              ...
              <p className="text-gray-600">
                {actionType === 'promote' 
                  ? `Give ${selectedUser.name} full admin access to Haven? They will be able to manage users, send broadcasts, and access all admin tools.`
                  : `Remove admin access from ${selectedUser.name}? They will lose access to the admin dashboard and management tools.`
                }
              </p>
            </div>
