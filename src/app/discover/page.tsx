            ...
            {filteredFamilies.length === 0 ? (
              ...
              {filteredFamilies.length > 0 && (
                <div className="text-center py-6 text-sm text-gray-400">
                  ...
                  <a href="/settings" className="mt-3 inline-flex flex-col items-center gap-1 group">
                    <div className="w-12 h-12 rounded-2xl bg-white border border-gray-200 shadow-sm flex items-center justify-center group-hover:bg-emerald-50 group-hover:border-emerald-300 transition-all">
                    ...
                    <span className="text-xs text-gray-400 group-hover:text-emerald-600 transition-colors">Settings</span>
                  </a>
                </div>
              )}
              </>
